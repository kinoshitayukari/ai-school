const articles = [
  {
    href: "/articles/aichi_prefectural_university_data_science_1.html",
    title: "愛知県立大学でデータサイエンスを学ぶ！学部・入試・キャリアを徹底解説",
  },
  {
    href: "/articles/data_science_ai_1.html",
    title: "データサイエンスとAIの基礎からキャリアまで|文系出身者向け学習ガイド",
  },
  {
    href: "/articles/data_science_ai_agent_1.html",
    title: "データサイエンスとAIエージェントが拓く未来！業務効率化とビジネス成長の秘訣",
  },
  {
    href: "/articles/data_science_ai_alternative_1.html",
    title: "データサイエンティストはAIに代替される？未来を切り拓くキャリア戦略",
  },
  {
    href: "/articles/data_science_ai_certification_1.html",
    title: "データサイエンス・AI資格でキャリアを拓く！選び方と学習法",
  },
  {
    href: "/articles/data_science_ai_difference_1.html",
    title: "はじめての家庭菜園完全ガイド｜土作りから収穫まで、心豊かなベランダ菜園のすすめ",
  },
  {
    href: "/articles/data_science_ai_education_program_1.html",
    title: "「nan」の向こう側へ：数値化できない「ゆたかさ」を見つける旅",
  },
  {
    href: "/articles/data_science_ai_relationship.html",
    title: "未経験・文系でもわかる！データサイエンスとAIの関係性＆キャリアパス",
  },
  {
    href: "/articles/data_science_ai_responsibility_1.html",
    title: "データサイエンスとAIの責任問題：PMが知るべき法的・倫理的課題と実践的対策",
  },
  {
    href: "/articles/data_science_ai_utilization_1.html",
    title: "データサイエンスとAI活用で営業力強化！導入メリットと成功事例",
  },
  {
    href: "/articles/data_science_aichi_1.html",
    title: "データサイエンスを愛知県で学ぶ！社会人向け学習方法とキャリア戦略",
  },
  {
    href: "/articles/data_science_finance_1.html",
    title: "金融業界を革新するデータサイエンスの力！活用事例とキャリアパスを徹底解説",
  },
  {
    href: "/articles/data_science_finance_job_search_1.html",
    title: "データサイエンスで金融業界へ転職！成功の鍵とキャリアパスを徹底解説",
  },
  {
    href: "/articles/data_science_financial_engineering_1.html",
    title: "金融アナリスト必見！データサイエンス×金融工学で拓くキャリア",
  },
  {
    href: "/articles/data_science_icon_1.html",
    title: "【無料あり】データサイエンスアイコンの選び方と活用術！資料・ブログで差をつける",
  },
  {
    href: "/articles/data_science_stock_investment_1.html",
    title: "データサイエンスを株式投資に活用！安定利益へ導く実践手法",
  },
  {
    href: "/articles/data_science_stock_price_1.html",
    title: "データサイエンスで株価を予測！分析手法から実践まで徹底解説",
  },
  {
    href: "/articles/math_data_science_ai_education_program_completion_certificate_1.html",
    title: "数理・データサイエンス・AI教育プログラム修了証で市場価値向上！文系でも実践スキルを学ぶ",
  },
  {
    href: "/articles/mathematical_data_science_ai_education_program_certification_scheme_benefits_1.html",
    title: "【文系学生必見】数理・DS・AI教育プログラム認定制度のメリットとキャリア活用術",
  },
  {
    href: "/articles/mathematical_data_science_ai_education_program_job_hunting_1.html",
    title: "文系でも就活有利に！数理・データサイエンス・AI教育プログラムの全貌",
  },
  {
    href: "/articles/mathematical_data_science_ai_education_program_open_badge_1.html",
    title: "数理・データサイエンス・AI教育プログラム×オープンバッジで市場価値を高める！",
  },
  {
    href: "/articles/mathematical_data_science_ai_education_program_university_1.html",
    title: "文系出身者必見！大学の数理・データサイエンス・AI教育プログラムで未来を掴む",
  },
  {
    href: "/articles/mathematics_data_science_ai_education_program_resume_1.html",
    title: "【26歳プログラマー向け】数理・データサイエンス・AI教育プログラムの履歴書活用法",
  },
  {
    href: "/articles/nihon_soken_financial_data_science_1.html",
    title: "日本総研が牽引する金融データサイエンス最前線：実践事例とキャリアパス",
  },
];
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <ul className="mt-8 grid gap-4 text-sm sm:grid-cols-2 lg:grid-cols-3">
              {articles.map((article) => (
                ...
                >
                  <a href={article.href} className="font-semibold text-slate-900 hover:text-indigo-700">
                    {article.title}
                  </a>
                </li>
              ))}
